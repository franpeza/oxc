...
// Object keys never wrap: a template literal is not a valid key
const k = clsx({ "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background": cond });
